...
//import { GUI } from "./libs/lil-gui.module.min";

//import { GUI } from "../static/js/libs/lil-gui.module.min";
...
function init() {
    ...
    const sprite4 = textureLoader.load( '../static/img/sprites/spark.png' );
